...
public class DungeonXMLHandler extends DefaultHandler{
    ...
    // private ArrayList passages = new ArrayList();
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        if (qName.equalsIgnoreCase("Dungeon")) {
            dungeon.bottomHeight = Integer.parseInt(attributes.getValue("bottomHeight"));
            dungeon.gameHeight = Integer.parseInt(attributes.getValue("gameHeight"));
            dungeon.topHeight = Integer.parseInt(attributes.getValue("topHeight"));
            dungeon.width = Integer.parseInt(attributes.getValue("width"));
            // String name = attributes.getValue("name");
            // ObjectDisplayGrid objectDisplayGrid = new ObjectDisplayGrid(width, bottomHeight + gameHeight + topHeight, rooms, passages, players, monsters, items);
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        ...
        if (qName.equalsIgnoreCase("Rooms")) {
            ...
            addItem(armorBeingParsed);
            isArmor = false;
        } else if (qName.equalsIgnoreCase("Sword")) {
            addItem(swordBeingParsed);
            isSword = false;
        } else if (qName.equalsIgnoreCase("Scroll")) {
            addItem(scrollBeingParsed);
            isScroll = false;
            isItemAction = false;
        } else if (qName.equalsIgnoreCase("Player")) {
            addPlayer(playerBeingParsed);
            isPlayer = false;
            isArmor = false;
            isSword = false;
            isCreatureAction = false;
        } else if (qName.equalsIgnoreCase("Monster")) {
            addMonster(monsterBeingParsed);
